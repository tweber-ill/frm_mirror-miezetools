...
static bool ends_with(const std::string& str, const std::string& strEnd, double& dPow)
{
	...
	{
		tl::log_err("Unknown prefix \"", strPrefix, "\".");;
		dPow = 1.;
	}
	else
		dPow = (*iter).second;
...
get_freq(const std::string& strVar)
{
	...
	{
		tl::log_err("Unknown frequency unit: \"", strUnit, "\".");
...
get_energy(const std::string& strVar)
{
	...
	{
		energy = dPow * dVal * tl::one_eV;
	}
	else
	{
		tl::log_err("Unknown energy unit: \"", strUnit, "\".");
...
get_length(const std::string& strVar)
{
	...
	{
		tl::log_err("Unknown length unit: \"", strUnit, "\".");
...
get_wavenumber(const std::string& strVar)
{
	...
	{
		tl::log_err("Unknown wavenumber unit: \"", strUnit, "\".");
...
get_temperature(const std::string& strVar)
{
	...
	{
		tl::log_err("Error: Unknown temperature unit: \"", strUnit, "\".");
...
get_angle(const std::string& strVar)
{
	...
	{
		tl::log_err("Unknown angle unit: \"", strUnit, "\".");
...
double get_scalar(const std::string& strVar)
{
	...
	{
		tl::log_err("Unknown scalar unit: \"", strUnit, "\".");
		return 0.;
	}
